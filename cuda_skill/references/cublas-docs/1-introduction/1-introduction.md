...
The cuBLAS Library exposes four sets of APIs:
  ...
  * The [cuBLAS API](#using-the-cublas-api), which is simply called cuBLAS API in this document (starting with CUDA 6.0),

  * The [cuBLASXt API](#using-the-cublasxt-api) (starting with CUDA 6.0), and

  * The [cuBLASLt API](#using-the-cublaslt-api) (starting with CUDA 10.1)

  * The [cuBLASDx API](#using-the-cublasdx-api) (not shipped with the CUDA Toolkit)
